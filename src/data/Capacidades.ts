...
export const capacidades: CategoriaCapacidades[] = [
  {
    ...
    capacidades: [
      ...
      { nome: "Kit de Alquimia", custoPadrao: 4, custoProfissional: 2, profissoesRelacionadas: ["Alquimista", "Herbalismo"], preco: "" },
      { nome: "Kit de Herbalismo", custoPadrao: 3, custoProfissional: 1, profissoesRelacionadas: ["Herbalista", "Fazendeiro"], preco: "" },
      { nome: "Kit de Embalsamamento", custoPadrao: 3, custoProfissional: 1, profissoesRelacionadas: ["Cultista", "Cientista"], preco: "" },
      { nome: "Kit de Taverna", custoPadrao: 2, custoProfissional: 0, profissoesRelacionadas: ["Taverneiro", "Cozinheiro", "Alquimista"], preco: "" },
      { nome: "Kit Médico", custoPadrao: 4, custoProfissional: 2, profissoesRelacionadas: ["Alquimista", "Cientista"], preco: "" },
  ...
  },
  {
    ...
    capacidades: [
      { nome: "Kit de Cartografia", custoPadrao: 2, custoProfissional: 0, profissoesRelacionadas: ["Cartógrafo", "Marinheiro", "Militar"], preco: "" },
      { nome: "Kit de Navegação", custoPadrao: 3, custoProfissional: 1, profissoesRelacionadas: ["Marinheiro", "Caçador"], preco: "" },
  ...
  },
  {
    ...
    capacidades: [
      { nome: "Kit Musical", custoPadrao: 2, custoProfissional: 0, profissoesRelacionadas: ["Bardo", "Taverneiro"], preco: "" },
